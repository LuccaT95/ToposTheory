theory Chisholm_D imports SDL                 (*Christoph Benzmüller & Xavier Parent, 2018*)
...
begin (* Chisholm Example *) 
 ...
 axiomatization where
  ...
  D2: "\<lfloor>go \<^bold>\<rightarrow> \<^bold>O\<^bold>\<langle>tell\<^bold>\<rangle>\<rfloor>"  (*It ought to be that if Jones goes, then he tells them he is coming.*) and
